...
def get_game_steps():
    ...
    steps = [
        ...
        ('Global', tap_macro, (660, 1), 2),
        ('Chaos Left', tap_macro, (294, 380), 7),
        ...
        ('Space', tap_macro, (1141, 663), 6),
        ('Global', tap_macro, (660, 1), 2),
        ('Team Formation 1', tap_macro, (178, 345), 4),
        ...
        ('Research', find_research, None, 3),     # Open CV Required
        ('Space', tap_macro, (1141, 663), 9),
        ('Space', tap_macro, (1141, 663), 6),
        ('Space', tap_macro, (1141, 663), 8),

        # Blue Pot - 1
        ('Chaos Top Stage', tap_macro, (847, 162), 15),
        ...
        ('Rest Confirm', tap_macro, (896, 486), 8),
        ('Rest Leave', tap_macro, (1140, 667), 4),
        ('Map Middle', tap_macro, (1017, 370), 12),
        ('Fight', fighting_logic, None, 3),
        ('Fight Skip', tap_macro, (873, 661), 4),
        ('Fight Skip Confirm', tap_macro, (922, 455), 6),
        ('Map Middle', tap_macro, (1017, 370), 16),
        ('Global', tap_macro, (660, 1), 3),
        ('Global', tap_macro, (660, 1), 3),
        ...
        ('Global', tap_macro, (660, 1), 2),
        ('Space', tap_macro, (1141, 663), 6),
        # ('Map Middle', tap_macro, (1017, 370), 14),
        # ('Fight', fighting_logic, None, 3),  
        # ('Fight Skip', tap_macro, (873, 661), 5),
        # ('Fight Skip Confirm', tap_macro, (922, 455), 4),
        # ('Global', tap_macro, (660, 1), 6),
        # ('Map Middle', tap_macro, (1017, 370), 12),
        # ('Global', tap_macro, (660, 1), 4),
        # ('Fight', fighting_logic, None, 4),
        # ('Fight Skip', tap_macro, (873, 661), 4),
        # ('Fight Skip Confirm', tap_macro, (922, 455), 6),
        # ('Map Middle', tap_macro, (1017, 370), 7),
        # ('Rest Free', tap_macro, (420, 536), 6),
        # ('Rest Confirm', tap_macro, (896, 486), 6),
        # ('Space', tap_macro, (1141, 663), 6),
        # ('Map Middle', tap_macro, (1017, 370), 14),
        # ('Fight', fighting_logic, None, 3),
        # ('Fight Skip', tap_macro, (873, 661), 4),
        # ('Fight Skip Confirm', tap_macro, (922, 455), 6),
        # ('Map Middle', tap_macro, (1017, 370), 12),
        # ('Message Center', tap_macro, (640, 615), 3),
        # ('Message Center', tap_macro, (640, 615), 8),
        # ('Space', tap_macro, (1141, 663), 6),
        # ('Space', tap_macro, (1141, 663), 8),
        # ('Map Middle', tap_macro, (1017, 370), 15),
        # ('Global', tap_macro, (660, 1), 2),
        # ('Global', tap_macro, (660, 1), 4),
        # ('Message Center', tap_macro, (640, 615), 3),
        # ('Message Center', tap_macro, (640, 615), 8),
        ...
        # ('Global', tap_macro, (660, 1), 2),
        # ('Global', tap_macro, (660, 1), 2),
        # ('Message Middle', tap_macro, (640, 615), 3),
        # ('Global', tap_macro, (660, 1), 2),
        # ('Global', tap_macro, (660, 1), 2),
        # ('Global', tap_macro, (660, 1), 2),
        # ('Space', tap_macro, (1141, 663), 6),
        ...
        # ('Space', tap_macro, (1141, 663), 6),
        # ('Map Middle', tap_macro, (1017, 370), 14),
        # ('Fight', fighting_logic, None, 5),
        # ('Fight Skip', tap_macro, (873, 661), 4),
        # ('Fight Skip Confirm', tap_macro, (922, 455), 8),
        # ('Message Center', tap_macro, (640, 615), 5),
        # ('Global', tap_macro, (660, 1), 2),
        # ('Global', tap_macro, (660, 1), 2),
        # ('Map Middle', tap_macro, (1017, 370), 12),
        # ('Rest Free', tap_macro, (420, 536), 5),
        # ('Rest Confirm', tap_macro, (896, 486), 6),
        # ('Map Middle', tap_macro, (1017, 370), 12),
        # ('Global', tap_macro, (660, 1), 2),
        # ('Fight', fighting_logic_boss, None, 4),
        # ('Space', tap_macro, (1141, 663), 6),
        # ('Message Center', tap_macro, (640, 615), 5),
        # ('Global', tap_macro, (660, 1), 2),
        # ('Space', tap_macro, (1141, 663), 8),
        # ('Message Center', tap_macro, (640, 615), 3),
        # ('Space', tap_macro, (1141, 663), 6),
        # ('Ring Tut', tap_macro, (1154, 219), 2),
        # ('Space', tap_macro, (1141, 663), 4),
        # ('Space', tap_macro, (1141, 663), 3),
        # ('Space', tap_macro, (1141, 663), 5),
        # ('Obtain Reward', tap_macro, (836, 511), 4),
        # ('Global', tap_macro, (660, 1), 4),
        # ('Space', tap_macro, (1141, 663), 12),
        # ('Space', tap_macro, (1141, 663), 3),
        # ('Space', tap_macro, (1141, 663), 7),
        # ('Space', tap_macro, (1141, 663), 9),
        # ('Return', tap_macro, (51, 32), 4),
        # ('Return', tap_macro, (51, 32), 3),
        # ('Return', tap_macro, (51, 32), 3),
        ...
        ('Claim All Mail', tap_macro, (180, 250), 15),
        ('Global', tap_macro, (660, 1), 2),
        ('Global', tap_macro, (660, 1), 2),
        ('Global', tap_macro, (660, 1), 4),
        ('Menu', tap_macro, (1226, 39), 3),
